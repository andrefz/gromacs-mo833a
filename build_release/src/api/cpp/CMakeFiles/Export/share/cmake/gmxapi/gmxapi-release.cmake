...
set_target_properties(Gromacs::gmxapi PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "libgromacs"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgmxapi.so.0.1.0"
  IMPORTED_SONAME_RELEASE "libgmxapi.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS Gromacs::gmxapi )
list(APPEND _IMPORT_CHECK_FILES_FOR_Gromacs::gmxapi "${_IMPORT_PREFIX}/lib/libgmxapi.so.0.1.0" )
